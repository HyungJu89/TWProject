    ...
    useEffect(() => {
        if (route === 'giveUp') {
            setRouteText([
                ...
                '채널 관리자 포기 신청 시 철회는 불가합니다.',
                '채널 관리자를 포기 시 관리자를 신청한 사람이 생길 때까지 유지됩니다. (만약, 포기 이후 신청한 관리자가 없다면 공지사항에 자동으로 모집이 올라갑니다. 다음 관리자가 생기지 않으면 포기 신청 기준 n일까지 관리자 해야 합니다. 어쩌구 저쩌구?)',
                '채널 관리자 포기하기'
            ]);
        }
    }, [route]);
        ...
        <div>
            ...
            <div className={style.announcementArea}>
                <div className={style.formGroup}>
                    <img src='https://health.chosun.com/site/data/img_dir/2024/02/20/2024022002560_0.jpg' alt="채널 이미지" />
            ...
            <div className={style.announcementTitle}><img src={checklist} alt="체크리스트"/>{routeText[1]}</div>{/* 채널 개설 설명 제목*/}
